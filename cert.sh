...
rsync -vaLzSHe ssh ./config/live/$DOMAIN/privkey.pem $BITNAMI:/opt/bitnami/nginx/conf/bitnami/certs/server.key
rsync -vaLzSHe ssh ./config/live/$DOMAIN/fullchain.pem $BITNAMI:/opt/bitnami/nginx/conf/bitnami/certs/server.crt
